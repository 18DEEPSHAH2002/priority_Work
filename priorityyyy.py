...
def load_data():
    ...
    try:
        ...
        # FIX: Standardize the date column name to handle variations like 'Date&Time of Assign'
        if 'Date&Time of Assign' in df.columns:
            df.rename(columns={'Date&Time of Assign': 'Date of Assign'}, inplace=True)
        ...
        if 'Date of Assign' in df.columns:
